...
###########################################
base_parameters = {}
base_parameters["experiment_name"] = "tl_1v2:wisig-oracle.run1.limited"
...
base_parameters["n_way"]  = min(len(wisig.ALL_NODES_MINIMUM_100_EXAMPLES), len(ALL_SERIAL_NUMBERS))
